...
PHP_MINIT_FUNCTION(fftw)
{
	...
	*/
	REGISTER_FFTW_CONSTANT(FFTW_HC2R);
	REGISTER_FFTW_CONSTANT(FFTW_R2HC);
	REGISTER_FFTW_CONSTANT(FFTW_DHT);
	REGISTER_FFTW_CONSTANT(FFTW_REDFT00);
	REGISTER_FFTW_CONSTANT(FFTW_REDFT10);
	REGISTER_FFTW_CONSTANT(FFTW_REDFT01);
	REGISTER_FFTW_CONSTANT(FFTW_REDFT11);
	REGISTER_FFTW_CONSTANT(FFTW_RODFT00);
	REGISTER_FFTW_CONSTANT(FFTW_RODFT10);
	REGISTER_FFTW_CONSTANT(FFTW_RODFT01);
	REGISTER_FFTW_CONSTANT(FFTW_RODFT11);
